    ...
    <div class="dashboard-layout">
        ...
        <main class="main-content">
            <header class="content-header">
                ...
                <p>Manage class discussions and announcements</p>
            </header>

            <!-- New Discussion Button -->
            <div style="margin-bottom: 2rem;">
                <button onclick="showNewDiscussionModal()" class="btn btn-primary">
                    <i class="fas fa-plus"></i> New Announcement / Discussion
                </button>
            </div>
        ...
        async function loadDiscussions() {
            try {
                ...
                if (result.success && result.data.length > 0) {
                    ...
                    container.innerHTML = '<div class="empty-state"><i class="fas fa-comments"></i><p>No discussions yet. Create the first one!</p></div>';
                }
            } catch (error) {
                    ...
                    container.innerHTML = result.data.map(reply => `
                        <div style="background: rgba(8, 145, 178, 0.05); padding: 1rem; border-radius: 8px; margin-bottom: 0.75rem; border-left: 3px solid #0891B2;">
                            <div style="display: flex; justify-content: space-between; align-items: start; margin-bottom: 0.5rem;">
                                <strong>${reply.author_name} (${reply.author_role})</strong>
